      ...
      {showHotels && (
        <div style={{
          ...
          <p style={{ color: "rgba(240,234,214,0.55)", marginBottom: 24, fontSize: 14 }}>
            Hôtels disponibles à Makokou — Réservez à l'avance !
          </p>
          {hotels.map((h, i) => (
            <div key={i} style={{
        ...
        {activeTab === "infos" && (
          <div>
            ...
            <div style={{ display: "grid", gap: 18 }}>
              {[
                {
                  titre: "🗺️ Comment venir à Makokou ?",
                  contenu: "Makokou est accessible par la route nationale depuis Libreville (~620 km) ou par avion via l'Aéroport de Makokou (MKU). Des transports en commun (bus, taxis-brousse) sont disponibles depuis les grandes villes du Gabon.",
                  action: null,
                },
                {
                  titre: "🏨 Hébergement",
                  contenu: "Voir la liste des hôtels disponibles à Makokou →",
                  action: "hotels",
                },
                {
                  titre: "🎟️ Accès aux événements",
                  contenu: "L'entrée à toutes les festivités est entièrement gratuite et ouverte à l'ensemble de la population gabonaise et aux visiteurs étrangers. Venez en famille !",
                  action: null,
                },
                {
                  titre: "🌿 Ogooué-Ivindo",
                ...
                {
                  titre: "📞 Contact officiel",
                  contenu: "Pour toute information complémentaire, contactez la Préfecture de l'Ogooué-Ivindo ou la Mairie de Makokou.",
                  action: null,
                },
              ].map((card, i) => (
                <div key={i} onClick={() => {
